...
const data: Data = {
  words: [
        ...
        samples: [
          {
            ...
            sample:
              "Der Anhänger ist am hinteren Teil des Lastwagens befestigt.",
          },
          {
            translation: "He towed the trailer with his car.",
            sample: "Er zog den Anhänger mit seinem Auto.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      level: "A1",
      type: "NOUN",
      categories: ["General", "Animals and pets"],
      spec: {
        article: "Der",
        meanings: ["dog"],
        plural: "Hunde",
        samples: [
          {
            translation: "The dog is playing in the park.",
            sample: "Der Hund spielt im Park.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "A wolf is a wild animal that lives in forests.",
            sample: "Ein Wolf ist ein wildes Tier, das in Wäldern lebt.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        article: "Das",
        meanings: ["animal", "creature"],
        plural: "Tiere",
        samples: [
          {
            translation: "The zoo has many different animals.",
            sample: "Der Zoo hat viele verschiedene Tiere.",
          },
          {
            translation: "Animals are an important part of our ecosystem.",
            sample: "Tiere sind ein wichtiger Teil unseres Ökosystems.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The monkey swung from tree to tree.",
            sample: "Der Affe schwang sich von Baum zu Baum.",
          },
          {
            translation:
              "Monkeys are known for their intelligence and agility.",
            sample:
              "Affen sind für ihre Intelligenz und Beweglichkeit bekannt.",
          },
        ],
      } as NounSpec,
    },
        ...
        samples: [
          {
            ...
            sample:
              "Schlangen sind in verschiedenen Lebensräumen auf der ganzen Welt zu finden.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      level: "B1",
      type: "NOUN",
      categories: ["General", "Animals and pets", "Nature"],
      spec: {
        article: "Der",
        meanings: ["habitat", "living space"],
        plural: "Lebensräume",
        samples: [
          {
            translation: "Protecting animal habitats is important.",
            sample: "Der Schutz von Lebensräumen für Tiere ist wichtig.",
          },
        ],
      } as NounSpec,
    },
        ...
        samples: [
          {
            ...
            sample: "Das Pferd läuft auf dem Feld.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The cow is grazing in the meadow.",
            sample: "Die Kuh grast auf der Wiese.",
          },
          {
            translation: "Cows produce milk for dairy products.",
            sample: "Kühe produzieren Milch für Milchprodukte.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The sheep are in the pasture.",
            sample: "Die Schafe sind auf der Weide.",
          },
          {
            translation: "Sheep provide wool for clothing.",
            sample: "Schafe liefern Wolle für Kleidung.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        article: "Das",
        meanings: ["cattle", "bovine"],
        plural: "Rinder",
        samples: [
          {
            translation: "Cattle are raised for meat and dairy products.",
            sample: "Rinder werden für Fleisch- und Milchprodukte gezüchtet.",
          },
          {
            translation: "The farm has a large herd of cattle.",
            sample: "Der Bauernhof hat eine große Rinderherde.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The pig is rolling in the mud.",
            sample: "Das Schwein wälzt sich im Schlamm.",
          },
          {
            translation: "Pigs are intelligent animals.",
            sample: "Schweine sind intelligente Tiere.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The eagle soars high in the sky.",
            sample: "Der Adler schwebt hoch am Himmel.",
          },
          {
            translation: "Eagles have excellent vision.",
            sample: "Adler haben ausgezeichnetes Sehvermögen.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The lion is known as the king of the jungle.",
            sample: "Der Löwe ist als König des Dschungels bekannt.",
          },
          {
            translation: "Lions live in prides and hunt together.",
            sample: "Löwen leben in Rudeln und jagen gemeinsam.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The jungle was dark and scary.",
            sample: "Der Dschungel war dunkel und unheimlich.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The tiger is a powerful animal.",
            sample: "Der Tiger ist ein mächtiges Tier.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The zebra has distinctive black and white stripes.",
            sample: "Das Zebra hat markante schwarz-weiße Streifen.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The bird is singing in the tree.",
            sample: "Der Vogel singt im Baum.",
          },
          {
            translation: "Birds can fly high in the sky.",
            sample: "Vögel können hoch am Himmel fliegen.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The alligator lives in swamps and rivers.",
            sample: "Der Alligator lebt in Sümpfen und Flüssen.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "We spent the weekend at the lake.",
            sample: "Wir verbrachten das Wochenende am See.",
          },
        ],
      } as NounSpec,
    },
        ...
        samples: [
          {
            ...
            sample: "Der Elefant ist das größte Landtier.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The mouse is small and quick.",
            sample: "Die Maus ist klein und flink.",
          },
          {
            translation: "Mice like to eat cheese.",
            sample: "Mäuse essen gerne Käse.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The fish is swimming in the pond.",
            sample: "Der Fisch schwimmt im Teich.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "Sharks are found in oceans around the world.",
            sample: "Haie sind in Ozeanen auf der ganzen Welt zu finden.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The frog is jumping near the pond.",
            sample: "Der Frosch springt in der Nähe des Teichs.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The pond is home to many frogs and fish.",
            sample: "Der Teich ist die Heimat vieler Frösche und Fische.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "Many animals return to their homeland to breed.",
            sample:
              "Viele Tiere kehren in ihre Heimat zurück, um sich zu paaren.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The fox is known for its cunning nature.",
            sample: "Der Fuchs ist für seine listige Natur bekannt.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "Crows are highly intelligent birds.",
            sample: "Krähen sind hochintelligente Vögel.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The goat is climbing the rocky hill.",
            sample: "Die Ziege klettert den felsigen Hügel hinauf.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The donkey is carrying a heavy load.",
            sample: "Der Esel trägt eine schwere Last.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: " A bear is a very strong animal.",
            sample: "Ein Bär ist ein sehr starkes Tier.",
          },
          {
            translation: "Bears like eating honey and fish.",
            sample: "Bären essen gerne Honig und Fisch.",
          },
        ],
      } as NounSpec,
    },
    {
      ...
      spec: {
        ...
        samples: [
          {
            translation: "The duck is swimming in the pond.",
            sample: "Die Ente schwimmt im Teich.",
          },
        ],
      } as NounSpec,
    },
